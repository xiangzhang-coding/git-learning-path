...
一个基于 VitePress 的静态课程站：分六个阶段由浅入深地教授 Git/GitHub **常用命令**及其原理，支持 8 种语言、站内**练手区**（浏览器内执行 git 命令并实时绘制提交图）与即时反馈**练习**，部署于 GitHub Pages。
...
阶段 0–5：概念与环境 → 本地基础 → 分支与合并 → 远程协作 → 修复与进阶 → GitHub 生态。每课覆盖 2–4 个常用命令 + 原理主线 + 练习 + 练手区场景。
